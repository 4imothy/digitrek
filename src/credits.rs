...
pub const FONTFORGE_TEXT: &str = "fontforge to edit the font";
pub const FONTFORGE_LINK: &str = "https://fontforge.org";

pub const FFMPEG_TEXT: &str = "ffmpeg to edit the sounds";
pub const FFMPEG_LINK: &str = "https://ffmpeg.org";

pub const WORDS_TEXT: &str = "google books ngrams for the word pool";
pub const WORDS_LINK: &str = "https://books.google.com/ngrams";

pub const GWORDLIST_TEXT: &str = "gwordlist to process the word pool";
pub const GWORDLIST_LINK: &str = "https://github.com/hackerb9/gwordlist";
